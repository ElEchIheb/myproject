<section id="services" class="section bg-light-secondary dark:bg-dark-secondary">
    <div class="container mx-auto">
        <div class="flex flex-col items-center text-center">
            ...
            <p class="subtitle">
                Ici je presente mes services pour les clients.
            </p>
        </div>
        <div class="grid md:grid-cols-2 md:gap-4 lg:grid-cols-4 lg:gap-8">
            <div class="bg-light-tail-100 dark:bg-dark-navy-500 p-6 rounded-2xl">
                ...
                <p>
                    is the work involved in developing a website for the Internet (World Wide Web) or an intranet (a private network). Web development can range from developing a simple single static page of plain text to complex web applications, electronic businesses, and social network services.
                </p>
            </div>
            <div class="bg-light-tail-100 dark:bg-dark-navy-500 p-6 rounded-2xl">
                <div
            ...
            <div class="bg-light-tail-100 dark:bg-dark-navy-500 p-6 rounded-2xl">
                ...
                <p>
                    A mobile app, or mobile application, is a software application developed specifically to run on small, wireless devices such as smartphones, tablets, and smartwatches, rather than on desktops or laptops.
                </p>
            </div>
            <div class="bg-light-tail-100 dark:bg-dark-navy-500 p-6 rounded-2xl">
                <div
