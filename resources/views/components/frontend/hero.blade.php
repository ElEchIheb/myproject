    ...
    <div class="container mx-auto h-full">
        <div class="flex flex-col lg:flex-row items-center h-full pt-8">
            <div class="flex-1 flex flex-col items-center lg:items-start">
                <p class="text-lg text-accent text-md mb-[22px]">Yoooooooo , Iheb is Here</p>
                <h1
                    class="
                        text-4xl
                        leading-[44px]
                ...
                <p
                    ...
                    lg:text-left
                    ">
                    Salut, je suis un etudiant a isi kef.
                </p>
                <button
                    class="
                        btn btn-md
                ...
                <div class="pt-12">
                    ...
                    <div class="flex items-center mb-6">
                        <a class="
                                ...
                                sm:mr-4
                                "
                            href="https://www.facebook.com/profile.php?id=100066967402885">
            ...
            <div class="flex flex-1 justify-end items-center h-full mt-8 md:mt-0  ">
                <img class="rounded-lg" src="/img/hero.jpg" alt="Hero img" width="450" height="550" />
            </div>
        </div>
    </div>
</section>
